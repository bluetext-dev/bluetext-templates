package dev.bluetext.curity.couchbase.configuration;
...
import static dev.bluetext.curity.couchbase.CouchbaseBucketDataAccessProvider.BUCKET_COLLECTION_NAME;
import static dev.bluetext.curity.couchbase.CouchbaseDatabaseClientDataAccessProvider.DB_CLIENT_COLLECTION_NAME;
import static dev.bluetext.curity.couchbase.CouchbaseDeviceDataAccessProvider.DEVICE_COLLECTION_NAME;
import static dev.bluetext.curity.couchbase.CouchbaseDynamicallyRegisteredClientDataAccessProvider.DCR_COLLECTION_NAME;
import static dev.bluetext.curity.couchbase.CouchbaseSessionDataAccessProvider.SESSION_COLLECTION_NAME;
import static dev.bluetext.curity.couchbase.CouchbaseUserAccountDataAccessProvider.ACCOUNT_COLLECTION_NAME;
import static dev.bluetext.curity.couchbase.CouchbaseUserAccountDataAccessProvider.LINKED_ACCOUNT_COLLECTION_NAME;
import static dev.bluetext.curity.couchbase.token.CouchbaseDelegationDataAccessProvider.DELEGATION_COLLECTION_NAME;
import static dev.bluetext.curity.couchbase.token.CouchbaseNonceDataAccessProvider.NONCE_COLLECTION_NAME;
import static dev.bluetext.curity.couchbase.token.CouchbaseTokenDataAccessProvider.TOKEN_COLLECTION_NAME;
...
public class DBSetupRunners  {
    ...
    public void run(Cluster cluster, Bucket bucket, Scope scope) {
        ...
        var collections = Arrays.asList(
                BUCKET_COLLECTION_NAME, SESSION_COLLECTION_NAME, ACCOUNT_COLLECTION_NAME,
                DELEGATION_COLLECTION_NAME, NONCE_COLLECTION_NAME, TOKEN_COLLECTION_NAME,
                DEVICE_COLLECTION_NAME, DCR_COLLECTION_NAME, DB_CLIENT_COLLECTION_NAME,
                LINKED_ACCOUNT_COLLECTION_NAME);
