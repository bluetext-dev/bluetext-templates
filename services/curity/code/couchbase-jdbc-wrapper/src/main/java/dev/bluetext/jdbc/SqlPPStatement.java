...
/**
 * Statement wrapper that translates SQL via the parent SqlPPConnection.
 * DDL statements (CREATE TABLE, etc.) return no-op results since collections
 * are pre-created by service-config-manager.
 */
public class SqlPPStatement implements Statement {
    ...
    public SqlPPStatement(Statement delegate, SqlPPConnection connection) {
        this.delegate = delegate;
        this.connection = connection;
    }

    @Override public ResultSet executeQuery(String sql) throws SQLException {
        String translated = connection.translateSql(sql);
        if (translated == null) return new NoOpPreparedStatement.NoOpResultSet();
        return delegate.executeQuery(translated);
    }
    @Override public int executeUpdate(String sql) throws SQLException {
        String translated = connection.translateSql(sql);
        if (translated == null) return 0;
        return delegate.executeUpdate(translated);
    }
    @Override public boolean execute(String sql) throws SQLException {
        String translated = connection.translateSql(sql);
        if (translated == null) return false;
        return delegate.execute(translated);
    }
    @Override public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        String translated = connection.translateSql(sql);
        if (translated == null) return 0;
        return delegate.executeUpdate(translated, autoGeneratedKeys);
    }
    @Override public int executeUpdate(String sql, int[] columnIndexes) throws SQLException {
        String translated = connection.translateSql(sql);
        if (translated == null) return 0;
        return delegate.executeUpdate(translated, columnIndexes);
    }
    @Override public int executeUpdate(String sql, String[] columnNames) throws SQLException {
        String translated = connection.translateSql(sql);
        if (translated == null) return 0;
        return delegate.executeUpdate(translated, columnNames);
    }
    @Override public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
        String translated = connection.translateSql(sql);
        if (translated == null) return false;
        return delegate.execute(translated, autoGeneratedKeys);
    }
    @Override public boolean execute(String sql, int[] columnIndexes) throws SQLException {
        String translated = connection.translateSql(sql);
        if (translated == null) return false;
        return delegate.execute(translated, columnIndexes);
    }
    @Override public boolean execute(String sql, String[] columnNames) throws SQLException {
        String translated = connection.translateSql(sql);
        if (translated == null) return false;
        return delegate.execute(translated, columnNames);
    }
