...
public class SqlPPStatement implements Statement {
    ...
    // SQL-executing methods need translation — delegate to connection's translateSql
    // For now, we let PreparedStatement handle most translation (Curity uses prepareStatement)
    // Statement.execute* methods pass through since Curity rarely uses raw statements
